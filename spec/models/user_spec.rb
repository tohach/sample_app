...
describe User do
  ...
  before do
    @user = User.new(name: "Example User", email: "user@xample.com", 
  ...
  describe "with admin attributes se to 'true '" do
  ...
  describe "return value of authenticaed value" do
    before {@user.save}
  ...
  describe "micropost association" do
    ...
    describe "status" do
      ...
      before do
        ...
        3.times {followed_user.microposts.create(content: "this is a twit")}
